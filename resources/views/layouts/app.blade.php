        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="index.html">Universitas Matana</a>
                    </div>
                    <ul class="sidebar-menu">
                        ...
                        @can('visimisis.index')
                                <li class="{{ setActive('admin/visimisi') }}"><a class="nav-link" href="{{ route('admin.visimisi.index') }}
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2022 <div class="bullet"></div> Agustinus TI 2018 <div class="bullet"></div> Admin Universitas Matana
                </div>
